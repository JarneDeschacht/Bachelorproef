...
\begin{center}
    ...
    \begin{longtable}{| P{2.2cm} | p{2.2cm} |  p{2.2cm} | p{2.2cm} | p{2.2cm} | p{2.2cm} |}
        ...
        \textbf{Systeem intents}                                       & Nee                                                                     & Nee                & Ja, door specifieke componenten te gebruiken & Nee, Wit.ai bestaat uit enkel entities & Ja, uitgebreide lijst van voorgebouwde agents \\  \hline
